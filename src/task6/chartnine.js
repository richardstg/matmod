...
export const options = {
  ...
  plugins: {
    ...
    title: {
      display: true,
      text: "Histogram för linjära residualer",
      color: "black",
    },
  },
  scales: {
